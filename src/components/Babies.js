...
import './Brothers.css'; // Import your CSS file for styling

function Main() {
// Sample image data (you can replace with your own image URLs)
  const imageList = Array.from({ length:3 }, (_, i) => `${process.env.PUBLIC_URL}/images/babies/${i+1}.jpg`);
...
const closeModal = () => {
  ...
  return (
    <section>
      <p style={{fontSize:'1rem' }}>Babies...</p>
